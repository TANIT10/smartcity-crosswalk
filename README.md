...
- YOLOv8과 OpenCV를 활용한 보행자 탐지 및 횡단보도 ROI 판정
- Flask API와 MJPEG 영상 스트리밍 백엔드 구현
- 차량 접근 거리·속도·경고 상태를 보여주는 React 대시보드 구현
- 로컬 CCTV와 배포용 샘플 영상을 분리하고 Railway·Vercel 배포 구성
